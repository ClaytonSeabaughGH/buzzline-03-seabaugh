...
def send_alert(message):
    ...
    # Slack webhook or email logic can go here
...
message_counter = Counter('kafka_messages_processed', 'Total number of messages processed')
start_http_server(8000)  # Prometheus scrapes this

# Increment counter when processing a message
message_counter.inc()
